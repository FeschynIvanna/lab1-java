...
public class PenManagerTest {
    ...
    public void testFindAllTheBiggerThan() {
        ...
        //assertEquals(3, penManager.findAllTheBiggerThan(15).size(2));
    }
    @Test
    void testFindAllTheBiggerThanHigherThanAllPens() {
        ...
        assertEquals(4, penManager.findTheBiggerThan(17).size());
    }
    ...
    public void testFindColor() {
        ...
        assertEquals(1, penManager.findColor("Red").size());
        ...
        public void testAddPen() {
            ...
            assertTrue(penManager.getPens().contains(new RulerPen(104, "Black", "Office", 12, 3, "Metal")));
    }
